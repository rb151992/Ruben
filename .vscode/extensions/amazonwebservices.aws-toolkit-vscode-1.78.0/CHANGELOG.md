...
- **Feature** AWS Explorer: clicking "Failed to load" node navigates to failure details [#1569](https://github.com/aws/aws-toolkit-vscode/issues/1569)
- **Feature** SAM Deploy wizard: show recently-used S3 buckets; ability to input S3 bucket name manually [#1527](https://github.com/aws/aws-toolkit-vscode/issues/1527)
- **Feature** SAM run/debug: Add support for Java 8, Java 8.al2, and Java 11 runtimes using Maven and Gradle
- **Feature** Step Functions: adds ability to publish/update state machine from ASL YAML files.
- **Feature** SAM run/debug: improve display of partial lines [#1581](https://github.com/aws/aws-toolkit-vscode/issues/1581)
- **Feature** "Create Lambda SAM Application": navigate to README.md instead of template.yaml [#1574](https://github.com/aws/aws-toolkit-vscode/issues/1574)
...
- **Feature** Improved validation when searching for SAM CLI [#1465](https://github.com/aws/aws-toolkit-vscode/issues/1465)

## 1.18.0 2021-01-07

- **Bug Fix** WatchedFiles improvements (Windows) [#1416](https://github.com/aws/aws-toolkit-vscode/issues/1416)
- **Bug Fix** SAM debug: Fix deployment for image based lambdas in sam cli 1.14+ [#1448](https://github.com/aws/aws-toolkit-vscode/issues/1448)
- **Bug Fix** SAM debug: fix payload JSON validation [#1440](https://github.com/aws/aws-toolkit-vscode/issues/1440)
- **Feature** Adds ASL YAML linting and visualization support.
- **Feature** SAM debug: use debugpy instead of ptvsd [#1365](https://github.com/aws/aws-toolkit-vscode/issues/1365)
